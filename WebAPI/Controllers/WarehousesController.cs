...
using static Business.Handlers.Warehouses.Commands.UpdateWarehouseCommand.UpdateWarehouseCommandHandler;
...
namespace WebAPI.Controllers
{
    ...
    public class WarehousesController : BaseApiController
    {
        ...
        /// sen ekledinn unutmaa
        /// <summary>
        /// sen ekledinn unutmaa 
        /// </summary>
        /// <param name="updateWarehouseQuantity"></param>
        /// <returns></returns>
        [Produces("application/json", "text/plain")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPatch("updatequantity")]
        public async Task<IActionResult> UpdateQuantity([FromBody] UpdateWarehouseQuantityCommand updateWarehouseQuantity)
        {
            var result = await Mediator.Send(updateWarehouseQuantity);
            if (result.Success)
            {
                return Ok(result.Message);
            }
